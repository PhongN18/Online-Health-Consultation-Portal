...
function MemberAppointmentDetail() {
    ...
    const handleCancelAppointment = async () => {
        ...
        if (!window.confirm("Submit cancellation request for admin approval?")) return;
        ...
        try {
            ...
            setAppointment({ ...appointment, cancelReason, cancelApproved: null });
        } catch (err) {
                ...
                {showCancelForm && (
                    <div className="mt-4">
                        ...
                        <textarea
                            ...
                            placeholder="E.g., not available, changed mind, etc."
                        />
                        <button
                        ...
                        {medicalRecords
                            ...
                            .map((rec) => (
                                <li key={rec.recordId}>
                                    ...
                                    <span className="text-sm text-gray-500">Created: {formatDateTime(rec.createdAt)}</span>
                                </li>
                            ))}
                    </ul>
                )}
                        ...
                        {prescriptions
                            ...
                            .map((p) => (
                                <li key={p.prescriptionId}>
                                    ...
                                    <span className="text-sm text-gray-600">Created: {formatDateTime(p.createdAt)}</span><br />
